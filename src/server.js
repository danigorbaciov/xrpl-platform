...
app.get('/api/health', (req, res) => {
  res.json({ status: 'ok', platform: 'Dani Gorbaciov - XRP Live', network: 'XRPL', features: ['dashboard', 'loyalty', 'messenger', 'real-wallet', 'wallet-gen', 'encrypted-export', 'virtual-chat', 'admin-master-key'] });
});
